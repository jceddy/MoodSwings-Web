# Futuristic card skin (issue #363)
...
"Futuristic" selected as their card skin, and fall back to the base set's
own art automatically for any card that doesn't have a file here yet (a
