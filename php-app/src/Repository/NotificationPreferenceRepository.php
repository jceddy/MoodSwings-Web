...
final class NotificationPreferenceRepository
{
     ...
     * does.
     *
     * @return array{notify_your_turn: bool, notify_friend_request: bool, notify_game_finished: bool, disable_cooldown: bool}
     */
    public function forUser(int $userId): array
    {
        $stmt = Connection::get()->prepare(
            'SELECT notify_your_turn, notify_friend_request, notify_game_finished, disable_cooldown
    ...
    public function save(
        ...
        $stmt = Connection::get()->prepare(
            'INSERT INTO notification_preferences (user_id, notify_your_turn, notify_friend_request, notify_game_finished, disable_cooldown)
             VALUES (:user_id, :your_turn, :friend_request, :game_finished, :disable_cooldown)
