...
/** chaos_056 (uncommon, after_playing): "You may choose an opponent's mood. If you do, permanently reduce the chosen mood's value by this mood's value. If the chosen mood's value would become less than 0, put it in the discard pile instead." */
