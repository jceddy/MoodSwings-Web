...
/**
 * chaos_061 (uncommon, after_playing): "Choose any number of opponents
 * who each have two or more moods. Each chosen opponent puts a random one
 * of their moods into the discard pile. (Moods are cards in play.)" Same
 * shape as Effects/CrueltyEffect.php.
 */
final class Chaos061Effect extends AbstractChaosMoodEffect
{
